...
@SourceType(value = "WooCommerceARP", label = "WooCommerce",uiConfig = "woocommerce-layout.json")
public class WooCommerceConf extends AbstractArpConf<WooCommerceConf> {
  private static final String ARP_FILENAME = "arp/implementation/woocommerce-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.woocommerce.WooCommerceDriver";
